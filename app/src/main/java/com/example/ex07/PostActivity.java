...
public class PostActivity extends AppCompatActivity {
    ...
    class PostAdapter extends RecyclerView.Adapter<PostAdapter.VIewHolde> {
        ...
        @NonNull
        @Override
        public PostAdapter.VIewHolde onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view=getLayoutInflater().inflate(R.layout.item_post, parent, false);
            return new VIewHolde(view);
        }

        @Override
        public void onBindViewHolder(@NonNull PostAdapter.VIewHolde holder, int position) {
